...
app.title = "Blended Visual Beats"
...
page1_layout = dbc.Container(
    ...
    fluid=True,
    style={
        "backgroundImage": 'url("/assets/spotify.jpg")',  # Background image
...
def update_chart(field, nbins, opacity):
    fig = px.histogram(
        ...
        nbins=nbins,
        color="Playlist",
        color_discrete_sequence=["cyan", "lightpink"],
        opacity=opacity,
        cumulative=True,
        width=1400,
        height=600,
...
page6_layout = dbc.Container(
    ...
    fluid=True,
    style={
        "backgroundImage": 'url("/assets/spotify.jpg")',  
        "backgroundSize": "cover",
        "backgroundPosition": "center",
        "minHeight": "100vh",  
        "display": "flex",
...
def update_figure3(opacity):
    ...
    pd1 = {"Playlist 1": "cyan", "Playlist 2": "lightpink", "Both": "purple"}
...
welcome_page = html.Div(
    [
        html.Div(
            [
                html.H2(
                    "Welcome to Blended Visual Beats!",
                    style={
                ...
                html.P(
                    "Explore various visualizations related to music playlists.",
                ...
                html.Ul(
                    [
                        ...
                        html.Li("URL: Web URL for the song"),
...
main_page_layout = dbc.Container(
    [
        dbc.NavbarSimple(
            children=[],
            brand=html.Span(
                "Blended Visual Beats : Visualizing Playlist Comparisons and Personalized Music Recommendations",
                style={
                    "fontWeight": "bold",
                    "fontSize": "18px",
                    "color": "#ffffff",
...
def display_tab(tab_value):
    if tab_value == "/viz-1":
        return html.Div([html.H2("Visualization 1", style={
            "color": "#1DB954",  # Spotify green
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page1_layout])
    elif tab_value == "/viz-2":
        return html.Div([html.H2("Visualization 2", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page2_layout])
    elif tab_value == "/viz-3":
        return html.Div([html.H2("Visualization 3", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page3_layout])
    elif tab_value == "/viz-4":
        return html.Div([html.H2("Visualization 4", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page4_layout])
    elif tab_value == "/viz-5":
        return html.Div([html.H2("Visualization 5", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page5_layout])
    elif tab_value == "/viz-6":
        return html.Div([html.H2("Visualization 6", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page6_layout])
    elif tab_value == "/viz-7":
        return html.Div([html.H2("Visualization 7", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page7_layout])
    elif tab_value == "/viz-8":
        return html.Div([html.H2("Visualization 8", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page8_layout])
    elif tab_value == "/viz-9":
        return html.Div([html.H2("Visualization 9", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page9_layout])
    elif tab_value == "/viz-10":
        return html.Div([html.H2("Visualization 10", style={
            "color": "#1DB954", 
            "marginTop": "20px",
            "fontWeight": "bold",
        }), page10_layout])
